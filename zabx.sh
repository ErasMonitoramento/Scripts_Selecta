...
# Garantindo permissões para asname e run_asnamev6 diretamente
fix_specific_permissions() {
    echo "Garantindo permissões específicas para 'asname' e 'run_asnamev6'..."
    chmod +x "$destination_dir/asname"
    chmod +x "$destination_dir/run_asnamev6"
    echo "Permissões corrigidas para 'asname' e 'run_asnamev6'."
}
